...
class DS_seq(Dataset):
    def __init__(self, data, cfg, samples='val'):
        ...
        generators.append(Recurrent_Generator2(data, samples=samples, hydrogens=False, gibbs=False,
        ...
        if cfg.getboolean('training', 'hydrogens'):
            ...
            generators.append(Recurrent_Generator2(data, samples=samples, hydrogens=True, gibbs=False,
                                                   rand_rot=False, inter=True))
