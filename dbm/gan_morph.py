...
class GAN_seq():
    ...
    def __init__(self, device, cfg):
        ...
        self.gauss_hist_bond = GaussianHistogram_Dis(bins=64, min=0.0, max=1.0, sigma=0.001, ff=self.ff, device=device)
        ...
        self.gauss_hist_nb = GaussianHistogram_LJ(bins=64, min=0.0, max=4.0, sigma=0.1, ff=self.ff, device=device)
            ...
            for data_gen in data_generators:
                ...
                for d in data_gen:
                    ...
                    with torch.no_grad():
                        ...
                        new_coords, energies = self.predict(elems, aa_grid, energy_ndx, val_bs)
