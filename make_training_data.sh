...
#make ff file
python ./dbm/create_ff.py $path_to_aa_ff $res_name data/aa_top/$res_name.itp data/cg_top/$res_name.itp data/forcefield/$res_name.txt || echo "couldn't create a proper force field file :("
